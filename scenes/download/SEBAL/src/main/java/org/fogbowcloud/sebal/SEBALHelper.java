...
public class SEBALHelper {
    ...
    // Cria um contexto SSL que confia em todos os certificados (NÃO recomendado para produção)
    ...
    // Cria um HttpClient que usa o SSLContext acima e desabilita a verificação de hostname
    ...
    HttpGet homeGet = new HttpGet("https://www.spatialreference.org/ref/epsg/327" + zoneNumber + "/prettywkt/");
