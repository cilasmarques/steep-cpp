...
struct Landsat
{
  ...
  string evi_path, lai_path, pai_path;
   ...
   */
  void create_tiffs(TIFF **tal, TIFF **albedo, TIFF **ndvi, TIFF **evi, TIFF **lai, TIFF **pai, TIFF **soil_heat, TIFF **surface_temperature, TIFF **net_radiation);
